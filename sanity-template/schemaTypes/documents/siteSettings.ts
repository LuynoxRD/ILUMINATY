...
export const siteSettingsType = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'footerCreditConnector', title: 'Footer Credit Connector', type: 'string' }),
    defineField({ name: 'footerTechnologyName', title: 'Footer Technology Name', type: 'string' }),
    defineField({ name: 'footerTechnologyHref', title: 'Footer Technology URL', type: 'url' }),
    defineField({
      name: 'footerRepositoryLink',
      title: 'Footer Repository Link',
      type: 'object',
      fields: [
        defineField({ name: 'label', type: 'string' }),
